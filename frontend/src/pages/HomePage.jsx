...
import { getRecommendedUsers,getUserFriends , sendFriendRequest,getOutgoingFriendReqs } from "../lib/api.js";
      ...
      <div className="container mx-auto space-y-10">
         ...
         <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-center justify-between gap-4">
            <div>
              ...
              Discover the perfect friend to share your interests and talk about your goals
              </p>
            </div>
          </div>
         </div>
        ...
        { loadingUsers ? (
          ...
          <div className="card bg-base-200 p-6 text-center">
            <h3 className="font-semibold text-lg mb-3">No recommendations available</h3>
