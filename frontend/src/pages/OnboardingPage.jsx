        ...
        <div className="flex flex-col items-center justify-center space-y-4">
         ...
         {/* full Name */}
          <div className ="form-control">
           ...
           <span className="label_text">Full Name</span>
            </label>
            <input 
              type="text"
              name="fullName"
           ...
           <div classname="form-control">
                ...
                placeholder="Tell other about yourSelf and your langauge learning goals"
                />
            </div>
          {/* language */}
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
             <label className="label">
              <span className="lable-text">Native Langauge</span>
             </label>
          ...
          {/* learningLangauge */}
           ...
           <button className="btn btn-primary w-full " disabled={isPending} type="submit"> 
            {!isPending ? (
              ...
              <>
              <LoaderIcon className="animation-spin size-5 mr-2" />
              Onboarding...
              </>
            )}  
